...
<h1 align = "center"><% out.print(message.getProperty("admin.create.physics")); %></h1>
</div>
<div class="w3-panel w3-blue w3-card-4">
<% out.print(message.getProperty("admin.choose.physics")); %>
</div>
    <%
        List<String> questions = (ArrayList<String>) request.getAttribute("physicsQuestions");
