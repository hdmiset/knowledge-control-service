...
<title>Complete math test</title>
...
<h1 align = "center"><% out.print(message.getProperty("test.complete.label.math")); %></h1>
</div>
    <%
        List<String> questions = (ArrayList<String>) request.getAttribute("mathQuestionsList");
...
<form name = "myform" action="ProcessServlet" method="POST" name="form1" onsubmit="return isOneChecked()">
   ...
   <input type="hidden" name="sub" value="math">
