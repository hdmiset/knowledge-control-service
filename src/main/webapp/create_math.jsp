...
<h1 align = "center" ><% out.print(message.getProperty("admin.create.math")); %></h1>
</div>
<div class="w3-panel w3-blue w3-card-4">
<% out.print(message.getProperty("admin.choose.math")); %>
</div>
    <%
        List<String> questions = (ArrayList<String>) request.getAttribute("mathQuestions");
...
<c:forEach items="${questions}" var="val">
  <input type="checkbox" name="question" id = "questionName"  value="${button}">
