...
<title>Complete physics test</title>
</head>
<body class="w3-light-grey">
<div class="w3-container w3-pale-green">
<h1 align = "center"><% out.print(message.getProperty("test.complete.label.physics")); %></h1>
</div>
    <%
        List<String> questions = (ArrayList<String>) request.getAttribute("physicsQuestionsList");
...
<input type="hidden" name="sub" value="physics">
